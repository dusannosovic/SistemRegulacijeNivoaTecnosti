...
class ApiValve2(Resource):
    ...
    def get(self,parameter):
        ...
        if parameter == "status":
            ret_val = {"status": valve2.read_valve_status()}
        ...
        if parameter == "reset":
            ...
            try:
                ...
                if new_value < 0 or new_value > 1:
                    return json.dumps({"Message": "Invalid value for valve2 status"}), 400
                
                valve2.set_valve_status(new_value)
